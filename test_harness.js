...
(async () => {
  ...
  console.log('=== INIT ===');
  console.log('Campout panel active?', doc.getElementById('rg-panel-campout').classList.contains('rg-mode-panel-active'));
  console.log('Patrol panel active?', doc.getElementById('rg-panel-patrol').classList.contains('rg-mode-panel-active'));
  console.log('All panel active?', doc.getElementById('rg-panel-all').classList.contains('rg-mode-panel-active'));
